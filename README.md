...
following are good locations: `/usr/share/php/mince-1.2` or
`/usr/local/share/php/mince-1.2`

### Suggested Installation

    cd /usr/local/share/php
    git clone git://github.com/sumpygump/mince.git mince-1.2
    cd mince-1.2
    composer.phar install

Add a symlink to the mince program somewhere in your path

    ln -s /usr/local/share/php/mince-1.2/mince /usr/local/bin/mince
